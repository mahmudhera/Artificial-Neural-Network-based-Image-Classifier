...
public class ANN {
    ...
    public static void main(String[] args) {
        ...
        int [] layers = {MNISTLoader.NUM_FEATURES, 85, MNISTLoader.NUM_CLASSES};
        int minibatchsize = 900;

        Network net = constructNetwork(trainingSet, validationSet, layers, minibatchsize, 95, 100, 100, 0.0004);
    ...
    public static Network constructNetwork(ArrayList<Example> trainingSet, ArrayList<Example> validationSet, 
        ...
        while (bestAccuracy < targetAccuracy && iterationCount < MAX_STEPS) {
            ...
            Network net = new Network (trainingSet, layerSizes, minibatchsize, MNISTDatasetTest());
    ...
    static ArrayList<Example> MNISTDatasetTrain() {
        MNISTLoader loader = new MNISTLoader(MNISTLoader.TRAIN_LABEL, MNISTLoader.TRAIN_IMAGE);
         ArrayList<Example> al = loader.getRandomSubset(10000);
        return al;
    }
